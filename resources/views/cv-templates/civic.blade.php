...
<head>
	...
	<!-- Favicon -->
	<link href="{{asset('/cv-templates/civic/img/favicon.ico')}}" rel="shortcut icon"/>

	<!-- Google Fonts -->
	<link href="https://fonts.googleapis.com/css?family=Josefin+Sans:400,400i,600,600i,700" rel="stylesheet">

	<!-- Stylesheets -->
	<link rel="stylesheet" href="{{asset('/cv-templates/civic/css/bootstrap.min.css')}}"/>
	<link rel="stylesheet" href="{{asset('/cv-templates/civic/css/font-awesome.min.css')}}"/>
	<link rel="stylesheet" href="{{asset('/cv-templates/civic/css/flaticon.css')}}"/>
	<link rel="stylesheet" href="{{asset('/cv-templates/civic/css/owl.carousel.css')}}"/>
	<link rel="stylesheet" href="{{asset('/cv-templates/civic/css/magnific-popup.css')}}"/>
	<link rel="stylesheet" href="{{asset('/cv-templates/civic/css/style.css')}}"/>
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<figure class="hero-image">
								<img src="{{asset('/cv-templates/civic/img/hero.jpg')}}" alt="5">
							</figure>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-xl-3 col-lg-6 col-md-6">
						<div class="portfolio-item">
							<a href="{{asset('/cv-templates/civic/img/portfolio/1.jpg')}}" class="set-bg port-pic" data-setbg="{{asset('/cv-templates/civic/img/portfolio/1.jpg')}}"></a>
					...
					<div class="col-xl-3 col-lg-6 col-md-6">
						<div class="portfolio-item">
							<a href="{{asset('/cv-templates/civic/img/portfolio/2.jpg')}}" class="set-bg port-pic" data-setbg="{{asset('/cv-templates/civic/img/portfolio/2.jpg')}}"></a>
					...
					<div class="col-xl-3 col-lg-6 col-md-6">
						<div class="portfolio-item">
							<a href="{{asset('/cv-templates/civic/img/portfolio/3.jpg')}}" class="set-bg port-pic" data-setbg="{{asset('/cv-templates/civic/img/portfolio/3.jpg')}}"></a>
					...
					<div class="col-xl-3 col-lg-6 col-md-6">
						<div class="portfolio-item">
							<a href="{{asset('/cv-templates/civic/img/portfolio/4.jpg')}}" class="set-bg port-pic" data-setbg="{{asset('/cv-templates/civic/img/portfolio/4.jpg')}}"></a>
							<h2>Logo design</h2>
							<p>Graphic design</p>
						</div>
					</div>
				...
				<div class="col-xl-8 offset-xl-2">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6">
							<div class="fact-box">
								<div class="fact-content">
									<img src="{{asset('/cv-templates/civic/img/icon/1-w.png')}}" alt="">
									<h2>14</h2>
						...
						<div class="col-lg-3 col-md-6">
							<div class="fact-box">
								<div class="fact-content">
									<img src="{{asset('/cv-templates/civic/img/icon/2-w.png')}}" alt="">
									<h2>9</h2>
									<p>Awards Won</p>
								</div>
							</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<!--====== Javascripts & Jquery ======-->
	<script src="{{asset('/cv-templates/civic/js/jquery-2.1.4.min.js')}}"></script>
	<script src="{{asset('/cv-templates/civic/js/bootstrap.min.js')}}"></script>
	<script src="{{asset('/cv-templates/civic/js/owl.carousel.min.js')}}"></script>
	<script src="{{asset('/cv-templates/civic/js/magnific-popup.min.js')}}"></script>
	<script src="{{asset('/cv-templates/civic/js/circle-progress.min.js')}}"></script>
	<script src="{{asset('/cv-templates/civic/js/main.js')}}"></script>
</body>
</html>
