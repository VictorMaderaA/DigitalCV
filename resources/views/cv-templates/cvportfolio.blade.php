...
<head>
	...
	<link href="{{asset('/cv-templates/cvportfolio-box/common-css/bootstrap.css')}}" rel="stylesheet">

	<link href="{{asset('/cv-templates/cvportfolio-box/common-css/ionicons.css')}}" rel="stylesheet">

	<link href="{{asset('/cv-templates/cvportfolio-box/common-css/fluidbox.min.css')}}" rel="stylesheet">

	<link href="{{asset('/cv-templates/cvportfolio-box/01-cv-portfolio/css/styles.css')}}" rel="stylesheet">

	<link href="{{asset('/cv-templates/cvportfolio-box/01-cv-portfolio/css/responsive.css')}}" rel="stylesheet">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-10 col-lg-8">
					<div class="intro">
						<div class="profile-img"><img src="{{asset('/cv-templates/cvportfolio/images/profile-1-250x250.jpg')}}" alt=""></div>
	...
	<section class="portfolio-section section">
		...
		<div class="portfolioContainer">
			...
			<div class="p-item web-design">
				<a href="{{asset('/cv-templates/cvportfolio/images/portfolio-1-600x400.jpg')}}" data-fluidbox>
					<img src="{{asset('/cv-templates/cvportfolio/images/portfolio-1-600x400.jpg')}}" alt=""></a>
			</div><!-- p-item -->

			<div class="p-item branding graphic-design">
				<a href="{{asset('/cv-templates/cvportfolio/images/portfolio-7-600x800.jpg')}}" data-fluidbox>
					<img src="{{asset('/cv-templates/cvportfolio/images/portfolio-7-600x800.jpg')}}" alt=""></a>
			</div><!-- p-item -->

			<div class="p-item web-design">
				<a href="{{asset('/cv-templates/cvportfolio/images/portfolio-2-600x400.jpg')}}" data-fluidbox>
					<img src="{{asset('/cv-templates/cvportfolio/images/portfolio-2-600x400.jpg')}}" alt=""></a>
			</div><!-- p-item -->

			<div class="p-item p-item-2 graphic-design">
				<a class="img" href="{{asset('/cv-templates/cvportfolio/images/portfolio-8-300x400.jpg')}}" data-fluidbox>
					<img src="{{asset('/cv-templates/cvportfolio/images/portfolio-8-300x400.jpg')}}" alt=""></a>
				<a class="img" href="{{asset('/cv-templates/cvportfolio/images/portfolio-9-300x400.jpg')}}" data-fluidbox>
					<img src="{{asset('/cv-templates/cvportfolio/images/portfolio-9-300x400.jpg')}}" alt=""></a>
			</div><!-- p-item -->

			<div class="p-item branding graphic-design">
				<a href="{{asset('/cv-templates/cvportfolio/images/portfolio-3-600x400.jpg')}}" data-fluidbox>
					<img src="{{asset('/cv-templates/cvportfolio/images/portfolio-3-600x400.jpg')}}" alt=""></a>
			</div><!-- p-item -->

			<div class="p-item graphic-design web-design">
				<a href="{{asset('/cv-templates/cvportfolio/images/portfolio-4-600x400.jpg')}}" data-fluidbox>
					<img src="{{asset('/cv-templates/cvportfolio/images/portfolio-4-600x400.jpg')}}" alt=""></a>
			</div><!-- p-item -->

			<div class="p-item  graphic-design branding">
				<a href="{{asset('/cv-templates/cvportfolio/images/portfolio-5-600x800.jpg')}}" data-fluidbox>
					<img src="{{asset('/cv-templates/cvportfolio/images/portfolio-5-600x800.jpg')}}" alt=""></a>
			</div><!-- p-item -->

			<div class="p-item web-design branding">
				<a href="{{asset('/cv-templates/cvportfolio/images/portfolio-6-600x800.jpg')}}" data-fluidbox>
					<img src="{{asset('/cv-templates/cvportfolio/images/portfolio-6-600x800.jpg')}}" alt=""></a>
			</div><!-- p-item -->

			<div class="p-item p-item-2 graphic-design">
				<a class="img" href="{{asset('/cv-templates/cvportfolio/images/portfolio-10-300x400.jpg')}}" data-fluidbox>
					<img src="{{asset('/cv-templates/cvportfolio/images/portfolio-10-300x400.jpg')}}" alt=""></a>
				<a class="img" href="{{asset('/cv-templates/cvportfolio/images/portfolio-11-300x400.jpg')}}" data-fluidbox>
					<img src="{{asset('/cv-templates/cvportfolio/images/portfolio-11-300x400.jpg')}}" alt=""></a>
			</div><!-- p-item -->
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script src="{{asset('/cv-templates/cvportfolio-box/common-js/jquery-3.2.1.min.js')}}"></script>

	<script src="{{asset('/cv-templates/cvportfolio-box/common-js/tether.min.js')}}"></script>

	<script src="{{asset('/cv-templates/cvportfolio-box/common-js/bootstrap.js')}}"></script>

	<script src="{{asset('/cv-templates/cvportfolio-box/common-js/isotope.pkgd.min.js')}}"></script>

	<script src="{{asset('/cv-templates/cvportfolio-box/common-js/jquery.waypoints.min.js')}}"></script>

	<script src="{{asset('/cv-templates/cvportfolio-box/common-js/progressbar.min.js')}}"></script>

	<script src="{{asset('/cv-templates/cvportfolio-box/common-js/jquery.fluidbox.min.js')}}"></script>

	<script src="{{asset('/cv-templates/cvportfolio-box/common-js/scripts.js')}}"></script>
