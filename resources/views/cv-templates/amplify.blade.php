...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('/cv-templates/amplify/fonts/icomoon/style.css')}}">

    <link rel="stylesheet" href="{{asset('/cv-templates/amplify/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('/cv-templates/amplify/css/jquery-ui.css')}}">
    <link rel="stylesheet" href="{{asset('/cv-templates/amplify/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('/cv-templates/amplify/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{asset('/cv-templates/amplify/css/owl.theme.default.min.css')}}">

    <link rel="stylesheet" href="{{asset('/cv-templates/amplify/css/jquery.fancybox.min.css')}}">

    <link rel="stylesheet" href="{{asset('/cv-templates/amplify/css/bootstrap-datepicker.css')}}">

    <link rel="stylesheet" href="{{asset('/cv-templates/amplify/fonts/flaticon/font/flaticon.css')}}">

    <link rel="stylesheet" href="{{asset('/cv-templates/amplify/css/aos.css')}}">

    <link rel="stylesheet" href="{{asset('/cv-templates/amplify/css/style.css')}}">
  ...
  <div class="site-wrap">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-2 ml-auto"  data-aos="fade-up" data-aos-delay="100">
            <figure class="img-absolute">
              <img src="{{asset('/cv-templates/amplify/images/person_1.jpg')}}" alt="Image" class="img-fluid">
            </figure>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="image-absolute-box" >
              ...
              <img src="{{asset('/cv-templates/amplify/images/about_1.jpg')}}" alt="Image" class="img-fluid">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="site-section section-2" id="work-section">
      ...
      <div class="owl-carousel nonloop-block-13">
          ...
          <a class="work-thumb" href="{{asset('/cv-templates/amplify/images/about_1.jpg')}}" data-fancybox="gallery">
            <div class="work-text">
          ...
          <a class="work-thumb" href="{{asset('/cv-templates/amplify/images/slide_1.jpg')}}"  data-fancybox="gallery">
            <div class="work-text">
              <h3>Work Name Here</h3>
              <span class="category">Illustration</span>
            </div>
            <img src="{{asset('/cv-templates/amplify/images/slide_1.jpg')}}" alt="Image" class="img-fluid">
          </a>

          <a class="work-thumb" href="{{asset('/cv-templates/amplify/images/slide_2.jpg')}}"  data-fancybox="gallery">
            <div class="work-text">
              <h3>Work Name Here</h3>
              <span class="category">Branding</span>
            </div>
            <img src="{{asset('/cv-templates/amplify/images/slide_2.jpg')}}" alt="Image" class="img-fluid">
          </a>

          <a class="work-thumb" href="{{asset('/cv-templates/amplify/images/slide_3.jpg')}}"  data-fancybox="gallery">
            <div class="work-text">
              <h3>Work Name Here</h3>
              <span class="category">Web Development</span>
            </div>
            <img src="{{asset('/cv-templates/amplify/images/slide_3.jpg')}}" alt="Image" class="img-fluid">
          </a>

          <a class="work-thumb" href="{{asset('/cv-templates/amplify/images/slide_4.jpg')}}"  data-fancybox="gallery">
            <div class="work-text">
              <h3>Work Name Here</h3>
              <span class="category">Design</span>
            </div>
            <img src="{{asset('/cv-templates/amplify/images/slide_4.jpg')}}" alt="Image" class="img-fluid">
          </a>
      </div>
  ...
  <script src="{{asset('/cv-templates/amplify/js/jquery-3.3.1.min.js')}}"></script>
  <script src="{{asset('/cv-templates/amplify/js/jquery-migrate-3.0.1.min.js')}}"></script>
  <script src="{{asset('/cv-templates/amplify/js/jquery-ui.js')}}"></script>
  <script src="{{asset('/cv-templates/amplify/js/popper.min.js')}}"></script>
  <script src="{{asset('/cv-templates/amplify/js/bootstrap.min.js')}}"></script>
  <script src="{{asset('/cv-templates/amplify/js/owl.carousel.min.js')}}"></script>
  <script src="{{asset('/cv-templates/amplify/js/jquery.stellar.min.js')}}"></script>
  <script src="{{asset('/cv-templates/amplify/js/jquery.countdown.min.js')}}"></script>
  <script src="{{asset('/cv-templates/amplify/js/bootstrap-datepicker.min.js')}}"></script>
  <script src="{{asset('/cv-templates/amplify/js/jquery.easing.1.3.js')}}"></script>
  <script src="{{asset('/cv-templates/amplify/js/aos.js')}}"></script>
  <script src="{{asset('/cv-templates/amplify/js/jquery.fancybox.min.js')}}"></script>
  <script src="{{asset('/cv-templates/amplify/js/jquery.sticky.js')}}"></script>


  <script src="{{asset('/cv-templates/amplify/js/main.js')}}"></script>
