...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href="{{asset('/cv-templates/kenedy/img/fav.png')}}">
	<!-- Author Meta -->
	...
	<!--
			CSS
			============================================= -->
	<link rel="stylesheet" href="{{asset('/cv-templates/kenedy/css/linearicons.css')}}">
	<link rel="stylesheet" href="{{asset('/cv-templates/kenedy/css/font-awesome.min.css')}}">
	<link rel="stylesheet" href="{{asset('/cv-templates/kenedy/css/bootstrap.css')}}">
	<link rel="stylesheet" href="{{asset('/cv-templates/kenedy/css/magnific-popup.css')}}">
	<link rel="stylesheet" href="{{asset('/cv-templates/kenedy/css/nice-select.css')}}">
	<link rel="stylesheet" href="{{asset('/cv-templates/kenedy/css/animate.min.css')}}">
	<link rel="stylesheet" href="{{asset('/cv-templates/kenedy/css/owl.carousel.css')}}">
	<link rel="stylesheet" href="{{asset('/cv-templates/kenedy/css/main.css')}}">
</head>
	...
	<header id="header">
		<div class="container main-menu">
			<div class="row align-items-center d-flex">
				<div id="logo">
					<a href="index.html"><img src="{{asset('/cv-templates/kenedy/img/logo.png')}}" alt="" title="" /></a>
				</div>
		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center">
				...
				<div class="banner-img col-lg-6 col-md-6 align-self-end">
					<img class="img-fluid" src="{{asset('/cv-templates/kenedy/img/banner-img.png')}}" alt="">
				</div>
			</div>
		</div>
	</section>
			...
			<div class="brand-wrap">
				<div class="row align-items-center active-brand-carusel justify-content-start no-gutters">
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="{{asset('/cv-templates/kenedy/img/brand/b1.png')}}" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="{{asset('/cv-templates/kenedy/img/brand/b2.png')}}" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="{{asset('/cv-templates/kenedy/img/brand/b3.png')}}" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="{{asset('/cv-templates/kenedy/img/brand/b4.png')}}" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="{{asset('/cv-templates/kenedy/img/brand/b5.png')}}" alt=""></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-6 about-left">
					<img class="img-fluid" src="{{asset('/cv-templates/kenedy/img/about-img.jpg')}}" alt="">
				</div>
				...
				<div class="row grid">
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all creative wow fadeInUp" data-wow-duration="2s">
						<div class="relative">
							<div class="thumb">
								...
								<img class="image img-fluid" src="{{asset('/cv-templates/kenedy/img/work/w1.jpg')}}" alt="">
							</div>
							<div class="middle">
					...
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all web-design branding wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{asset('/cv-templates/kenedy/img/work/w2.jpg')}}" alt="">
							</div>
							<div class="middle">
								<h4>2D Vinyl Design</h4>
								<div class="cat">Client Project</div>
					...
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all branding web-design wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{asset('/cv-templates/kenedy/img/work/w3.jpg')}}" alt="">
							</div>
							<div class="middle">
								<h4>2D Vinyl Design</h4>
								<div class="cat">Client Project</div>
					...
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all web-design wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.6s">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{asset('/cv-templates/kenedy/img/work/w6.jpg')}}" alt="">
							</div>
							<div class="middle">
								<h4>2D Vinyl Design</h4>
								<div class="cat">Client Project</div>
					...
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all creative wow fadeInUp" data-wow-duration="2s">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{asset('/cv-templates/kenedy/img/work/w4.jpg')}}" alt="">
							</div>
							<div class="middle">
								<h4>2D Vinyl Design</h4>
								<div class="cat">Client Project</div>
					...
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all branding wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{asset('/cv-templates/kenedy/img/work/w5.jpg')}}" alt="">
							</div>
							<div class="middle">
								<h4>2D Vinyl Design</h4>
								<div class="cat">Client Project</div>
			...
			<div class="testi_slider owl-carousel">
				<div class="item">
					<div class="testi_item">
						<img src="{{asset('/cv-templates/kenedy/img/quote.png')}}" alt="">
						<h4>Fanny Spencer</h4>
						<ul class="list">
				...
				<div class="col-lg-12">
					<div class="footer-top flex-column">
						<div class="footer-logo">
							<a href="#">
								<img src="{{asset('/cv-templates/kenedy/img/logo.png')}}" alt="">
							</a>
							<h4>Follow Me</h4>
						</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<script src="{{asset('/cv-templates/kenedy/js/vendor/jquery-2.2.4.min.js')}}"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q"
	 crossorigin="anonymous"></script>
	<script src="{{asset('/cv-templates/kenedy/js/vendor/bootstrap.min.js')}}"></script>
	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
	<script src="{{asset('/cv-templates/kenedy/js/easing.min.js')}}"></script>
	<script src="{{asset('/cv-templates/kenedy/js/hoverIntent.js')}}"></script>
	<script src="{{asset('/cv-templates/kenedy/js/superfish.min.js')}}"></script>
	<script src="{{asset('/cv-templates/kenedy/js/mn-accordion.js')}}"></script>
	<script src="{{asset('/cv-templates/kenedy/js/jquery.ajaxchimp.min.js')}}"></script>
	<script src="{{asset('/cv-templates/kenedy/js/jquery.magnific-popup.min.js')}}"></script>
	<script src="{{asset('/cv-templates/kenedy/js/owl.carousel.min.js')}}"></script>
	<script src="{{asset('/cv-templates/kenedy/js/jquery.nice-select.min.js')}}"></script>
	<script src="{{asset('/cv-templates/kenedy/js/isotope.pkgd.min.js')}}"></script>
	<script src="{{asset('/cv-templates/kenedy/js/jquery.circlechart.js')}}"></script>
	<script src="{{asset('/cv-templates/kenedy/js/mail-script.js')}}"></script>
	<script src="{{asset('/cv-templates/kenedy/js/wow.min.js')}}"></script>
	<script src="{{asset('/cv-templates/kenedy/js/main.js')}}"></script>
</body>
