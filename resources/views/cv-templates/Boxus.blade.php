...
<html lang="en-US">
    <head>
        ...
        <link rel="shortcut icon" href="{{asset('/cv-templates/Boxus/images/favicon.png')}}" />
        ...
        <link rel="stylesheet" type="text/css"  href='{{asset('/cv-templates/Boxus/css/clear.css')}}' />
        <link rel="stylesheet" type="text/css"  href='{{asset('/cv-templates/Boxus/css/common.css')}}' />
        <link rel="stylesheet" type="text/css"  href='{{asset('/cv-templates/Boxus/css/font-awesome.min.css')}}' />
        <link rel="stylesheet" type="text/css"  href='{{asset('/cv-templates/Boxus/css/carouFredSel.css')}}' />
        <link rel="stylesheet" type="text/css"  href='{{asset('/cv-templates/Boxus/css/prettyPhoto.css')}}' />
        <link rel="stylesheet" type="text/css"  href='{{asset('/cv-templates/Boxus/css/sm-clean.css')}}' />
        <link rel="stylesheet" type="text/css"  href='{{asset('/cv-templates/Boxus/style.css')}}' />

        <!--[if lt IE 9]>
                <script src="{{asset('/cv-templates/Boxus/js/html5.js')}}"></script>
        <![endif]-->
    ...
    <body>
        ...
        <div id="home" class="section intro-page">
            <div class="block content-1170 center-relative center-text">
                <img class="top-logo" src="{{asset('/cv-templates/Boxus/demo-images/logo.png')}}" alt="Boxus" />
                <br>
                            ...
                            <ul id="slider1" class="image-slider slides">
                                <li>
                                    <div class="service-holder ">
                                        <img src="{{asset('/cv-templates/Boxus/demo-images/icon_01.png')}}" alt="">
                                    ...
                                    <div class="service-holder ">
                                        <img src="{{asset('/cv-templates/Boxus/demo-images/icon_02.png')}}" alt="">
                                        <div class="service-content-holder">
                                    ...
                                    <div class="service-holder ">
                                        <img src="{{asset('/cv-templates/Boxus/demo-images/icon_03.png')}}" alt="">
                                        <div class="service-content-holder">
                                    ...
                                    <div class="service-holder ">
                                        <img src="{{asset('/cv-templates/Boxus/demo-images/icon_04.png')}}" alt="">
                                        <div class="service-content-holder">
            ...
            <div class="block content-1170 center-relative">
                ...
                <div class="section-content-holder portfolio-holder left">
                    <div class="grid" id="portfolio-grid">
                        ...
                        <div class="grid-item element-item p_one">
                            <a href="single-portfolio.html">
                                <img src="{{asset('/cv-templates/Boxus/demo-images/portfolio_item_01.jpg')}}" alt="">
                                <div class="portfolio-text-holder">
                                    <div class="portfolio-text-wrapper">
                                        <p class="portfolio-type">
                                            <img src="{{asset('/cv-templates/Boxus/images/icon_post.svg')}}" alt="">
                                        </p>
                        ...
                        <div class="grid-item element-item p_one_half">
                            <a href="single-portfolio2.html">
                                <img src="{{asset('/cv-templates/Boxus/demo-images/portfolio_item_02.jpg')}}" alt="">
                                <div class="portfolio-text-holder">
                                    <div class="portfolio-text-wrapper">
                                        <p class="portfolio-type">
                                            <img src="{{asset('/cv-templates/Boxus/images/icon_post.svg')}}" alt="">
                        ...
                        <div class="grid-item element-item p_one_half">
                            <a data-rel="prettyPhoto[gallery1]" href="{{asset('/cv-templates/Boxus/demo-images/portfolio_item_08.jpg')}}">
                                <img src="{{asset('/cv-templates/Boxus/demo-images/portfolio_item_08.jpg')}}" alt="">
                                <div class="portfolio-text-holder">
                                    <div class="portfolio-text-wrapper">
                                        <p class="portfolio-type">
                                            <img src="{{asset('/cv-templates/Boxus/images/icon_post.svg')}}" alt="">
                        ...
                        <div class="grid-item element-item p_one">
                            <a data-rel="prettyPhoto[gallery1]" href="{{asset('/cv-templates/Boxus/demo-images/portfolio_item_05.jpg')}}">
                                <img src="{{asset('/cv-templates/Boxus/demo-images/portfolio_item_05.jpg')}}" alt="">
                                <div class="portfolio-text-holder">
                                    <div class="portfolio-text-wrapper">
                                        <p class="portfolio-type">
                                            <img src="{{asset('/cv-templates/Boxus/images/icon_post.svg')}}" alt="">
                    ...
                    <div class="block portfolio-load-more-holder">
                        ...
                        <img src="{{asset('/cv-templates/Boxus/images/icon_infinity.svg')}}" alt="Load more">
                    </div>
                </div>
                <div class="clear"></div>
            </div>
                        ...
                        <div class="image-slider-wrapper relative img aboutImage">
                            ...
                            <div class="caroufredsel_wrapper">
                                <ul id="aboutImage" class="image-slider slides">
                                    <li><img src="{{asset('/cv-templates/Boxus/demo-images/about_img_04.jpg')}}" alt=""></li>
                                    <li><img src="{{asset('/cv-templates/Boxus/demo-images/about_img_05.jpg')}}" alt=""></li>
                                    <li><img src="{{asset('/cv-templates/Boxus/demo-images/about_img_06.jpg')}}" alt=""></li>
                                </ul>
                            </div>
                            <div class="clear"></div>
                        </div>
                                ...
                                <ul id="team1" class="image-slider slides">
                                    <li>
                                        ...
                                        <div class="member-image-holder">
                                            <img src="{{asset('/cv-templates/Boxus/demo-images/about_img_01.jpg')}}" alt="">
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="member-image-holder">
                                            <img src="{{asset('/cv-templates/Boxus/demo-images/about_img_02.jpg')}}" alt="">
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="member-image-holder">
                                            <img src="{{asset('/cv-templates/Boxus/demo-images/about_img_03.jpg')}}" alt="">
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                                </ul>
                ...
                <div class="section-content-holder right">
                    ...
                    <div class="full-width ">
                        <a class="video-popup-holder" href="https://vimeo.com/157276599" data-rel="prettyPhoto[gallery-video1]">
                            <img class="thumb" src="{{asset('/cv-templates/Boxus/demo-images/video_img.jpg')}}" alt="">
                            <img class="popup-play" src="{{asset('/cv-templates/Boxus/images/icon_video.svg')}}" alt="Play">
                        </a>
                    </div>
                </div>
                <div class="clear"></div>
                ...
                <div class="fwslider1 fw-image-slider-holder list_carousel relative">
                    <div class="caroufredsel_wrapper">
                        <ul id="fwslider1" class="fw-image-slider">
                            <li class="fw-slide">
                                <img src="{{asset('/cv-templates/Boxus/demo-images/icon_editing.png')}}" alt="">
                                <p class="fw-slide-text">Video Editing</p>
                            </li>
                            <li class="fw-slide">
                                <img src="{{asset('/cv-templates/Boxus/demo-images/icon_clear.png')}}" alt="">
                                <p class="fw-slide-text">Premium Cleer</p>
                            </li>
                            <li class="fw-slide">
                                <img src="{{asset('/cv-templates/Boxus/demo-images/icon_display.png')}}" alt="">
                                <p class="fw-slide-text">For All Displays</p>
                            </li>
                            <li class="fw-slide">
                                <img src="{{asset('/cv-templates/Boxus/demo-images/icon_time.png')}}" alt="">
                                <p class="fw-slide-text">Right On Time</p>
                            </li>
                            <li class="fw-slide">
                                <img src="{{asset('/cv-templates/Boxus/demo-images/icon_ideas.png')}}" alt="">
                                <p class="fw-slide-text">Innovative Ideas</p>
                            </li>
                            <li class="fw-slide">
                                <img src="{{asset('/cv-templates/Boxus/demo-images/icon_sound.png')}}" alt="">
                                <p class="fw-slide-text">Perfect Sound</p>
                            </li>
                            <li class="fw-slide">
                                <img src="{{asset('/cv-templates/Boxus/demo-images/icon_solution.png')}}" alt="">
        ...
        <!--Load JavaScript-->
        <script type="text/javascript" src="{{asset('/cv-templates/Boxus/js/jquery.js')}}"></script>
        <script type='text/javascript' src='{{asset('/cv-templates/Boxus/js/jquery.sticky-kit.min.js')}}'></script>
        <script type='text/javascript' src='{{asset('/cv-templates/Boxus/js/jquery.smartmenus.min.js')}}'></script>
        <script type='text/javascript' src='{{asset('/cv-templates/Boxus/js/jquery.sticky.js')}}'></script>
        <script type='text/javascript' src='{{asset('/cv-templates/Boxus/js/jquery.dryMenu.js')}}'></script>
        <script type='text/javascript' src='{{asset('/cv-templates/Boxus/js/isotope.pkgd.js')}}'></script>
        <script type='text/javascript' src='{{asset('/cv-templates/Boxus/js/jquery.carouFredSel-6.2.0-packed.js')}}'></script>
        <script type='text/javascript' src='{{asset('/cv-templates/Boxus/js/jquery.mousewheel.min.js')}}'></script>
        <script type='text/javascript' src='{{asset('/cv-templates/Boxus/js/jquery.touchSwipe.min.js')}}'></script>
        <script type='text/javascript' src='{{asset('/cv-templates/Boxus/js/jquery.easing.1.3.js')}}'></script>
        <script type='text/javascript' src='{{asset('/cv-templates/Boxus/js/imagesloaded.pkgd.js')}}'></script>
        <script type='text/javascript' src='{{asset('/cv-templates/Boxus/js/jquery.prettyPhoto.js')}}'></script>
        <script type='text/javascript' src='{{asset('/cv-templates/Boxus/js/main.js')}}'></script>
    </body>
</html>
