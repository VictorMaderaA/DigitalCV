...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('/cv-templates/personify/css/bootstrap.css')}}">
    <link rel="stylesheet" href="{{asset('/cv-templates/personify/css/animate.css')}}">
    <link rel="stylesheet" href="{{asset('/cv-templates/personify/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/mediaelement@4.2.7/build/mediaelementplayer.min.css">

    <link rel="stylesheet" href="{{asset('/cv-templates/personify/fonts/ionicons/css/ionicons.min.css')}}">
    <link rel="stylesheet" href="{{asset('/cv-templates/personify/fonts/fontawesome/css/font-awesome.min.css')}}">


    <!-- Theme Style -->
    <link rel="stylesheet" href="{{asset('/cv-templates/personify/css/style.css')}}">
  </head>
  <body>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
      ...
      <aside style="background-image: url({{asset('/cv-templates/personify/img/profile_big.jpg')}});"></aside>
      <main>
    ...
    <script src="{{asset('/cv-templates/personify/js/jquery-3.2.1.min.js')}}"></script>
    <script src="{{asset('/cv-templates/personify/js/popper.min.js')}}"></script>
    <script src="{{asset('/cv-templates/personify/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('/cv-templates/personify/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('/cv-templates/personify/js/jquery.waypoints.min.js')}}"></script>
    <script src="{{asset('/cv-templates/personify/js/jquery.countdown.min.js')}}"></script>
    <script src="{{asset('/cv-templates/personify/js/main.js')}}"></script>
