...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href="{{asset('/cv-templates/ilene-berg/img/fav.png')}}">
	<!-- Author Meta -->
	...
	<link href="https://fonts.googleapis.com/css?family=Poppins:100,300,500" rel="stylesheet">
		...
		CSS
		============================================= -->
		<link rel="stylesheet" href="{{asset('/cv-templates/ilene-berg/css/linearicons.css')}}">
		<link rel="stylesheet" href="{{asset('/cv-templates/ilene-berg/css/owl.carousel.css')}}">
		<link rel="stylesheet" href="{{asset('/cv-templates/ilene-berg/css/font-awesome.min.css')}}">
		<link rel="stylesheet" href="{{asset('/cv-templates/ilene-berg/css/nice-select.css')}}">
		<link rel="stylesheet" href="{{asset('/cv-templates/ilene-berg/css/magnific-popup.css')}}">
		<link rel="stylesheet" href="{{asset('/cv-templates/ilene-berg/css/bootstrap.css')}}">
		<link rel="stylesheet" href="{{asset('/cv-templates/ilene-berg/css/main.css')}}">
	</head>
	<body>
		<!-- Start Header Area -->
			...
			<div class="container">
				<div class="header-wrap">
					<div class="header-top d-flex justify-content-between align-items-center">
						<div class="logo">
							<a href="index.html"><img src="{{asset('/cv-templates/ilene-berg/img/logo.png')}}" alt=""></a>
						</div>
				...
				<div class="row fullscreen align-items-center justify-content-center">
					<div class="col-lg-10">
						<div class="banner-content text-center">
							<h1 class="text-white">No Need to find, <br>
					...
					<div class="row justify-content-between">
						<div class="col-lg-4">
							<div class="tab-thumb text-center">
								<img src="{{asset('/cv-templates/ilene-berg/img/tab-thumb.jpg')}}" class="img-fluid" alt="">
							</div>
						</div>
				...
				<div class="row align-items-center">
					<div class="col-lg-3 col-md-6">
						<div class="vector-thumb">
							<img src="{{asset('/cv-templates/ilene-berg/img/v1.jpg')}}" class="img-fluid" alt="">
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="vector-thumb">
							<img src="{{asset('/cv-templates/ilene-berg/img/v2.jpg')}}" class="img-fluid" alt="">
						</div>
					</div>
					...
					<div class="item">
						<div class="row no-gutters">
							<div class="col-lg-8 col-md-6">
								<div class="carousel-thumb" style="background: url({{asset('/cv-templates/ilene-berg/img/c1.jpg')}});"></div>
							</div>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="single-footer-widget">
							...
							<ul class="instafeed d-flex flex-wrap">
								<li><img src="{{asset('/cv-templates/ilene-berg/img/i1.jpg')}}" alt=""></li>
								<li><img src="{{asset('/cv-templates/ilene-berg/img/i2.jpg')}}" alt=""></li>
								<li><img src="{{asset('/cv-templates/ilene-berg/img/i3.jpg')}}" alt=""></li>
								<li><img src="{{asset('/cv-templates/ilene-berg/img/i4.jpg')}}" alt=""></li>
								<li><img src="{{asset('/cv-templates/ilene-berg/img/i5.jpg')}}" alt=""></li>
								<li><img src="{{asset('/cv-templates/ilene-berg/img/i6.jpg')}}" alt=""></li>
								<li><img src="{{asset('/cv-templates/ilene-berg/img/i7.jpg')}}" alt=""></li>
								<li><img src="{{asset('/cv-templates/ilene-berg/img/i8.jpg')}}" alt=""></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<script src="{{asset('/cv-templates/ilene-berg/js/vendor/jquery-2.2.4.min.js')}}"></script>
		<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4" crossorigin="anonymous"></script>
		<script src="{{asset('/cv-templates/ilene-berg/js/vendor/bootstrap.min.js')}}"></script>
		<script src="{{asset('/cv-templates/ilene-berg/js/jquery.ajaxchimp.min.js')}}"></script>
		<script src="{{asset('/cv-templates/ilene-berg/js/owl.carousel.min.js')}}"></script>
		<script src="{{asset('/cv-templates/ilene-berg/js/jquery.nice-select.min.js')}}"></script>
		<script src="{{asset('/cv-templates/ilene-berg/js/jquery.magnific-popup.min.js')}}"></script>
		<script src="{{asset('/cv-templates/ilene-berg/js/main.js')}}"></script>
	</body>
</html>
