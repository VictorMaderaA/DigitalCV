...
<html lang="en-US">
    <head>
        ...
        <link rel="shortcut icon" href="{{asset('/cv-templates/katt/images/favicon.png')}}" />
        <link href='http://fonts.googleapis.com/css?family=Montserrat:400,700%7CPT+Serif:400,700' rel='stylesheet' type='text/css'>
        <link rel="stylesheet" type="text/css"  href='{{asset('/cv-templates/katt/css/clear.css')}}' />
        <link rel="stylesheet" type="text/css"  href='{{asset('/cv-templates/katt/css/common.css')}}' />
        <link rel="stylesheet" type="text/css"  href='{{asset('/cv-templates/katt/css/font-awesome.min.css')}}' />
        <link rel="stylesheet" type="text/css"  href='{{asset('/cv-templates/katt/css/carouFredSel.css')}}' />
        <link rel="stylesheet" type="text/css"  href='{{asset('/cv-templates/katt/css/sm-clean.css')}}' />
        <link rel="stylesheet" type="text/css"  href='{{asset('/cv-templates/katt/style.css')}}' />

        <!--[if lt IE 9]>
                <script src="{{asset('/cv-templates/katt/js/html5.js')}}"></script>
        <![endif]-->
    ...
    <body class="home blog">
        ...
        <div class="content-1170 header-holder center-relative">
            <div class="header-logo left">
                <a href="index.html">
                    <img src="{{asset('/cv-templates/katt/images/katt_default_logo.png')}}" alt="Katt">
                </a>
            </div>
            ...
            <div class="blog-holder block center-relative">
                        ...
                        <div class="image-slider-wrapper">
                            <div class="caroufredsel_wrapper">
                                <ul id="slider1" class="image-slider slides center-text">
                                    <li><img src="{{asset('/cv-templates/katt/demo-images/katt_home_image01_slider01.jpg')}}" alt=""></li>
                                    <li><img src="{{asset('/cv-templates/katt/demo-images/katt_home_image01_slider02.jpg')}}" alt=""></li>
                                    <li><img src="{{asset('/cv-templates/katt/demo-images/katt_home_image01_slider03.jpg')}}" alt=""></li>
                                </ul>
                            </div>
                ...
                <article id="post-2" class="relative blog-item-holder">
                    ...
                    <div class="zigzag absolute" style="bottom: 30px; left: -90px;">
                        <img src="{{asset('/cv-templates/katt/images/zigzag.png')}}" alt="">
                    </div>
                </article>
                ...
                <article id="post-3" class="relative blog-item-holder">
                    <div class="post-thumb thumb-image two_third_thumb left">
                        <img src="{{asset('/cv-templates/katt/demo-images/katt_home_image02.jpg')}}" alt="">
                    </div>
                ...
                <article id="post-4" class="relative blog-item-holder">
                    <div class="post-thumb thumb-image two_third_thumb right">
                        <img src="{{asset('/cv-templates/katt/demo-images/katt_home_image03.jpg')}}" alt="">
                    </div>
                ...
                <article id="post-5" class="relative blog-item-holder">
                    <div class="post-thumb thumb-image one_third_thumb left">
                        <img src="{{asset('/cv-templates/katt/demo-images/katt_home_image04.jpg')}}" alt="">
                    </div>
                ...
                <article id="post-7" class="relative blog-item-holder">
                    <div class="post-thumb thumb-image two_third_thumb right">
                        <img src="{{asset('/cv-templates/katt/demo-images/katt_home_image05.jpg')}}" alt="">
                    </div>
                    <div class="post-title-holder one_third_title left">
            ...
            <div class="content-1170 center-relative">
                <ul>
                    ...
                    <li class="center-footer-content">
                        <a href="index.html">
                            <img src="{{asset('/cv-templates/katt/images/katt_default_footer_logo.png')}}" alt="Katt">
                        </a>
                    </li>
        ...
        <div class="fixed scroll-top">
            <img src="{{asset('/cv-templates/katt/images/back_to_top.png')}}" alt="Go Top">
        </div>


        <script type="text/javascript" src="{{asset('/cv-templates/katt/js/jquery.js')}}"></script>
        <script type="text/javascript" src="{{asset('/cv-templates/katt/js/jquery.smartmenus.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('/cv-templates/katt/js/queryloader2.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('/cv-templates/katt/js/jquery.carouFredSel-6.0.0-packed.js')}}"></script>
        <script type="text/javascript" src="{{asset('/cv-templates/katt/js/jquery.mousewheel.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('/cv-templates/katt/js/jquery.touchSwipe.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('/cv-templates/katt/js/jquery.easing.1.3.js')}}"></script>
        <script type="text/javascript" src="{{asset('/cv-templates/katt/js/jquery.nicescroll.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('/cv-templates/katt/js/main.js')}}"></script>
